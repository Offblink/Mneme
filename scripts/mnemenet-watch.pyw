...
Single-instance. Configurable polling interval.
...
class WatchWindow(QMainWindow):
    ...
    def set_interval(self):
        ...
        try:
            ...
            self.status.setText(f"Interval set to {INTERVAL}s")
        except ValueError:
            ...
            for e in fp:
                ...
                if new:
                    ...
                    for c in new:
                        ...
                        if is_own:
                            reply = f"{target} -- Auto-reply: received. Agent will respond next cycle.\n\n-- omp"
                            try:
                                subprocess.run(
